...
| hubble.timescape.metrics.serviceMonitor.ui.interval | string | `"10s"` | Interval for scrape metrics (Timescape UI metrics) |
| hubble.timescape.metrics.serviceMonitor.ui.metricRelabelings | string | `nil` | Metrics relabeling configs for the ServiceMonitor (Timescape UI metrics) |
| hubble.timescape.metrics.serviceMonitor.ui.relabelings | string | `nil` | Relabeling configs for the ServiceMonitor (Timescape UI metrics) |
| hubble.timescape.metrics.serviceMonitor.ui.scrapeTimeout | string | `nil` | Timeout after which scrape is considered to be failed (Timescape UI metrics) |
| hubble.timescape.metrics.ui.enabled | bool | `true` | Enables exporting timescape ui metrics in OpenMetrics format. |
