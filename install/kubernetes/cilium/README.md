...
| enterprise.bgpControlPlane.routeImport.enabled | bool | `false` | Enables importing routes from BGP peers. |
...
| hubble.timescape.ingester.k8sImporter.enabled | bool | `true` | Whether to enable the k8s event watcher for the K8s Importer. When enabled, this effectively replaces the K8sExporter deployment. If both `.hubble.timescape.ingester.k8sImporter.enabled` and `.hubble.timescape.useStreamAPI` are true, vector will not be deployed. |
...
| hubble.timescape.useStreamAPI | bool | `true` | Use Stream API for Hubble Timescape. This automatically enables the Hubble Timescape exporter in Cilium and the Stream API in Hubble Timescape. If both `.hubble.timescape.ingester.k8sImporter.enabled` and `.hubble.timescape.useStreamAPI` are true, vector will not be deployed. |
