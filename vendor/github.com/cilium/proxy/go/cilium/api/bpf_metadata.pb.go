...
type BpfMetadata struct {
	...
	UseDeltaNpds  bool `protobuf:"varint,17,opt,name=use_delta_npds,json=useDeltaNpds,proto3" json:"use_delta_npds,omitempty"`
...
func (x *BpfMetadata) GetUseDeltaNpds() bool {
	if x != nil {
		return x.UseDeltaNpds
	}
	return false
}
