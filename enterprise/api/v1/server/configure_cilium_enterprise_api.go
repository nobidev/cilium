...
//go:generate swagger generate server --target ../../v1 --name CiliumEnterpriseAPI --spec ../openapi.yaml --api-package restapi --server-package server --principal interface{} --default-scheme unix

func configureFlags(api *restapi.CiliumEnterpriseAPIAPI) {
