...
var (
	...
	errMissingEvpnPathInfo    = errors.New("missing EVPN path info")
	errInvalidVNI             = errors.New("invalid VNI")
	errMissingRD              = errors.New("missing Route Distinguisher")
	errMissingRTs             = errors.New("missing Route Target")
	errMissingRoutersMAC      = errors.New("missing router's MAC")
)
