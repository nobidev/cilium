...
require (
	...
	github.com/cilium/ebpf v0.20.1-0.20251204155832-f150ced93791 // indirect
	...
	k8s.io/apiextensions-apiserver v0.35.0-rc.1 // indirect
	...
	sigs.k8s.io/mcs-api v0.3.1-0.20251209180531-e481ae73a51f // indirect
