...
func (UnimplementedFQDNProxyAgentServer) ProvideMappings(grpc.ClientStreamingServer[FQDNMapping, Success]) error {
	return status.Error(codes.Unimplemented, "method ProvideMappings not implemented")
}
func (UnimplementedFQDNProxyAgentServer) LookupEndpointByIP(context.Context, *FQDN_IP) (*Endpoint, error) {
	return nil, status.Error(codes.Unimplemented, "method LookupEndpointByIP not implemented")
}
func (UnimplementedFQDNProxyAgentServer) LookupSecurityIdentityByIP(context.Context, *FQDN_IP) (*Identity, error) {
	return nil, status.Error(codes.Unimplemented, "method LookupSecurityIdentityByIP not implemented")
}
func (UnimplementedFQDNProxyAgentServer) LookupIPsBySecurityIdentity(context.Context, *Identity) (*IPs, error) {
	return nil, status.Error(codes.Unimplemented, "method LookupIPsBySecurityIdentity not implemented")
}
func (UnimplementedFQDNProxyAgentServer) NotifyOnDNSMessage(context.Context, *DNSNotification) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method NotifyOnDNSMessage not implemented")
}
...
func (UnimplementedFQDNProxyAgentServer) SubscribeSelectors(*Empty, grpc.ServerStreamingServer[SelectorUpdate]) error {
	return status.Error(codes.Unimplemented, "method SubscribeSelectors not implemented")
}
func (UnimplementedFQDNProxyAgentServer) SubscribeFQDNRules(grpc.BidiStreamingServer[Empty, FQDNRules]) error {
	return status.Error(codes.Unimplemented, "method SubscribeFQDNRules not implemented")
}
...
func RegisterFQDNProxyAgentServer(s grpc.ServiceRegistrar, srv FQDNProxyAgentServer) {
	// If the following call panics, it indicates UnimplementedFQDNProxyAgentServer was
...
func (UnimplementedFQDNProxyServer) UpdateAllowed(context.Context, *FQDNRules) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateAllowed not implemented")
}
func (UnimplementedFQDNProxyServer) RemoveRestoredRules(context.Context, *EndpointID) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveRestoredRules not implemented")
}
...
func RegisterFQDNProxyServer(s grpc.ServiceRegistrar, srv FQDNProxyServer) {
	// If the following call panics, it indicates UnimplementedFQDNProxyServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
