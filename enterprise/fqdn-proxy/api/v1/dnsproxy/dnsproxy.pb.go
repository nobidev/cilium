...
const file_dnsproxy_dnsproxy_proto_rawDesc = "" +
	...
	"\x04FQDN\x18\x02 \x01(\tR\x04FQDN\"\xcd\x01\n" +
	"\vProxyStatus\x121\n" +
	"\x04enum\x18\x01 \x01(\x0e2\x18.dnsproxy.IPCacheVersionH\x00R\x04enum\x88\x01\x01\x12@\n" +
	"\ffqdnSelector\x18\x02 \x01(\v2\x1c.dnsproxy.FQDNSelectorUpdateR\ffqdnSelector\x12@\n" +
	"\ffqdnIdentity\x18\x03 \x01(\v2\x1c.dnsproxy.FQDNIdentityUpdateR\ffqdnIdentityB\a\n" +
	"\x05_enum\"r\n" +
	...
	"\x13UPDATETYPE_BOOKMARK\x10\x032\xa5\x04\n" +
	...
	"\vGetAllRules\x12\x0f.dnsproxy.Empty\x1a\x1a.dnsproxy.RestoredRulesMap\"\x00\x12D\n" +
	"\x16SubscribeProxyStatuses\x12\x0f.dnsproxy.Empty\x1a\x15.dnsproxy.ProxyStatus\"\x000\x01\x12@\n" +
...
var file_dnsproxy_dnsproxy_proto_depIdxs = []int32{
	...
	7,  // 26: dnsproxy.FQDNProxyAgent.SubscribeFQDNRules:input_type -> dnsproxy.Empty
	8,  // 27: dnsproxy.FQDNProxy.UpdateAllowed:input_type -> dnsproxy.FQDNRules
	6,  // 28: dnsproxy.FQDNProxy.RemoveRestoredRules:input_type -> dnsproxy.EndpointID
	6,  // 29: dnsproxy.FQDNProxy.GetRules:input_type -> dnsproxy.EndpointID
	21, // 30: dnsproxy.FQDNProxyAgent.ProvideMappings:output_type -> dnsproxy.Success
	22, // 31: dnsproxy.FQDNProxyAgent.LookupEndpointByIP:output_type -> dnsproxy.Endpoint
	14, // 32: dnsproxy.FQDNProxyAgent.LookupSecurityIdentityByIP:output_type -> dnsproxy.Identity
	12, // 33: dnsproxy.FQDNProxyAgent.LookupIPsBySecurityIdentity:output_type -> dnsproxy.IPs
	7,  // 34: dnsproxy.FQDNProxyAgent.NotifyOnDNSMessage:output_type -> dnsproxy.Empty
	2,  // 35: dnsproxy.FQDNProxyAgent.GetAllRules:output_type -> dnsproxy.RestoredRulesMap
	16, // 36: dnsproxy.FQDNProxyAgent.SubscribeProxyStatuses:output_type -> dnsproxy.ProxyStatus
	8,  // 37: dnsproxy.FQDNProxyAgent.SubscribeFQDNRules:output_type -> dnsproxy.FQDNRules
	7,  // 38: dnsproxy.FQDNProxy.UpdateAllowed:output_type -> dnsproxy.Empty
	7,  // 39: dnsproxy.FQDNProxy.RemoveRestoredRules:output_type -> dnsproxy.Empty
	3,  // 40: dnsproxy.FQDNProxy.GetRules:output_type -> dnsproxy.RestoredRules
