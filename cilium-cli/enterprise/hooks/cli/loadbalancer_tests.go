...
//  --client-image string
//        client container image name (default "quay.io/isovalent-dev/lb-frr-client:v0.0.8")
//  --ensure-images bool
...
func newCmdLoadbalancerTest() *cobra.Command {
	...
	cmd.Flags().StringVar(&ilbCli.FlagClientImage, "client-image", "quay.io/isovalent-dev/lb-frr-client:v0.0.8", "client container image name")
