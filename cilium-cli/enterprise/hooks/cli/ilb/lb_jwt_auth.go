...
func TestJWTAuth() {
	for _, proto := range []string{"http", "https"} {
		...
		fmt.Println("=== RUN   TestJWTAuth/ValidToken")
		...
		fmt.Println("=== RUN   TestJWTAuth/NoToken")
		...
		fmt.Println("=== RUN   TestJWTAuth/InvalidToken")
		...
		fmt.Println("=== RUN   TestJWTAuth/PerRouteException")
