...
func TestBasicAuth() {
	...
	for _, proto := range []string{"http", "https"} {
		...
		fmt.Printf("=== RUN   TestBasicAuth/%s/ValidCredentials\n", proto)
		...
		fmt.Printf("=== RUN   TestBasicAuth/%s/NoCredential\n", proto)
		...
		fmt.Printf("=== RUN   TestBasicAuth/%s/InvalidCredential\n", proto)
		...
		fmt.Printf("=== RUN   TestBasicAuth/%s/PerRouteException\n", proto)
