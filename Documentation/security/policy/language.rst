...
For Cilium versions prior to 1.13 deny policies for peers outside the cluster
sometimes did not work because of :gh-issue:`15198`.  Make sure that you are
using version 1.13 or later if you are relying on deny policies to manage
