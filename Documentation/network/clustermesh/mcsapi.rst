...
You might also need to enable :ref:`EndpointSlice synchronization <endpointslicesync>`
so that the Gateway API implementation can discover the ServiceImport EndpointSlices.
