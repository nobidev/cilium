...
## cilium-dbg statedb encryption-policy

Show contents of table "encryption-policy"

```
cilium-dbg statedb encryption-policy [flags]
```

### Options

```
  -h, --help            help for encryption-policy
