...
```
  ...
  -h, --help                                                         help for hive
      ...
      --loadbalancer-cp-accesslog-format-hc string                   Envoy Access Log format for T1 -> T2 Health Check HTTP requests that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline) (default "[%START_TIME%][access][healthcheck] protocol=\"%PROTOCOL%\" http.req.method=\"%REQ(:METHOD)%\" http.req.authority=\"%REQ(:AUTHORITY)%\" http.req.path=\"%REQ(X-ENVOY-ORIGINAL-PATH?:PATH)%\" http.req.x-forwarded-for=\"%REQ(X-FORWARDED-FOR)%\" http.req.user-agent=\"%REQ(USER-AGENT)%\" http.req.x-request-id=\"%REQ(X-REQUEST-ID)%\" http.resp.code=\"%RESPONSE_CODE%\" http.resp.code.details=\"%RESPONSE_CODE_DETAILS%\" response.flags=\"%RESPONSE_FLAGS%\" response.flags-long=\"%RESPONSE_FLAGS_LONG%\" connection.termination-details=\"%CONNECTION_TERMINATION_DETAILS%\" bytes.received=\"%BYTES_RECEIVED%\" bytes.sent=\"%BYTES_SENT%\" duration=\"%DURATION%\" stream.id=\"%STREAM_ID%\" downstream.connection-id=\"%CONNECTION_ID%\" downstream.local-address=\"%DOWNSTREAM_LOCAL_ADDRESS%\" downstream.direct-remote-address=\"%DOWNSTREAM_DIRECT_REMOTE_ADDRESS%\" downstream.remote-address=\"%DOWNSTREAM_REMOTE_ADDRESS%\" downstream.transport-failure-reason=\"%DOWNSTREAM_TRANSPORT_FAILURE_REASON%\" downstream.tls.cipher=\"%DOWNSTREAM_TLS_CIPHER%\" downstream.tls.version=\"%DOWNSTREAM_TLS_VERSION%\" downstream.tls.session-id=\"%DOWNSTREAM_TLS_SESSION_ID%\"")
      --loadbalancer-cp-accesslog-format-http string                 Envoy Access Log format for HTTP requests that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline) (default "[%START_TIME%][access][http] protocol=\"%PROTOCOL%\" http.req.method=\"%REQ(:METHOD)%\" http.req.authority=\"%REQ(:AUTHORITY)%\" http.req.path=\"%REQ(X-ENVOY-ORIGINAL-PATH?:PATH)%\" http.req.x-forwarded-for=\"%REQ(X-FORWARDED-FOR)%\" http.req.user-agent=\"%REQ(USER-AGENT)%\" http.req.x-request-id=\"%REQ(X-REQUEST-ID)%\" http.resp.code=\"%RESPONSE_CODE%\" http.resp.code.details=\"%RESPONSE_CODE_DETAILS%\" http.resp.x-envoy-upstream-service-time=\"%RESP(X-ENVOY-UPSTREAM-SERVICE-TIME)%\" response.flags=\"%RESPONSE_FLAGS%\" response.flags-long=\"%RESPONSE_FLAGS_LONG%\" connection.termination-details=\"%CONNECTION_TERMINATION_DETAILS%\" bytes.received=\"%BYTES_RECEIVED%\" bytes.sent=\"%BYTES_SENT%\" duration=\"%DURATION%\" stream.id=\"%STREAM_ID%\" downstream.connection-id=\"%CONNECTION_ID%\" downstream.local-address=\"%DOWNSTREAM_LOCAL_ADDRESS%\" downstream.direct-remote-address=\"%DOWNSTREAM_DIRECT_REMOTE_ADDRESS%\" downstream.remote-address=\"%DOWNSTREAM_REMOTE_ADDRESS%\" downstream.transport-failure-reason=\"%DOWNSTREAM_TRANSPORT_FAILURE_REASON%\" downstream.tls.cipher=\"%DOWNSTREAM_TLS_CIPHER%\" downstream.tls.version=\"%DOWNSTREAM_TLS_VERSION%\" downstream.tls.session-id=\"%DOWNSTREAM_TLS_SESSION_ID%\" upstream.connection-id=\"%UPSTREAM_CONNECTION_ID%\" upstream.host=\"%UPSTREAM_HOST%\" upstream.local-address=\"%UPSTREAM_LOCAL_ADDRESS%\" upstream.remote-address=\"%UPSTREAM_REMOTE_ADDRESS%\" upstream.transport-failure-reason=\"%UPSTREAM_TRANSPORT_FAILURE_REASON%\" upstream.tls.cipher=\"%UPSTREAM_TLS_CIPHER%\" upstream.tls.version=\"%UPSTREAM_TLS_VERSION%\" upstream.tls.session-id=\"%UPSTREAM_TLS_SESSION_ID%\"")
      --loadbalancer-cp-accesslog-format-tcp string                  Envoy Access Log format for the TCP listener that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline) (default "[%START_TIME%][access][tcp] protocol=\"%PROTOCOL%\" response.flags=\"%RESPONSE_FLAGS%\" response.flags-long=\"%RESPONSE_FLAGS_LONG%\" connection.termination-details=\"%CONNECTION_TERMINATION_DETAILS%\" bytes.received=\"%BYTES_RECEIVED%\" bytes.sent=\"%BYTES_SENT%\" duration=\"%DURATION%\" stream.id=\"%STREAM_ID%\" downstream.connection-id=\"%CONNECTION_ID%\" downstream.local-address=\"%DOWNSTREAM_LOCAL_ADDRESS%\" downstream.direct-remote-address=\"%DOWNSTREAM_DIRECT_REMOTE_ADDRESS%\" downstream.remote-address=\"%DOWNSTREAM_REMOTE_ADDRESS%\" downstream.transport-failure-reason=\"%DOWNSTREAM_TRANSPORT_FAILURE_REASON%\" downstream.tls.cipher=\"%DOWNSTREAM_TLS_CIPHER%\" downstream.tls.version=\"%DOWNSTREAM_TLS_VERSION%\" downstream.tls.session-id=\"%DOWNSTREAM_TLS_SESSION_ID%\" upstream.connection-id=\"%UPSTREAM_CONNECTION_ID%\" upstream.host=\"%UPSTREAM_HOST%\" upstream.local-address=\"%UPSTREAM_LOCAL_ADDRESS%\" upstream.remote-address=\"%UPSTREAM_REMOTE_ADDRESS%\" upstream.transport-failure-reason=\"%UPSTREAM_TRANSPORT_FAILURE_REASON%\" upstream.tls.cipher=\"%UPSTREAM_TLS_CIPHER%\" upstream.tls.version=\"%UPSTREAM_TLS_VERSION%\" upstream.tls.session-id=\"%UPSTREAM_TLS_SESSION_ID%\"")
      --loadbalancer-cp-accesslog-format-tls string                  Envoy Access Log format for TLS requests that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline) (default "[%START_TIME%][access][tls] protocol=\"%PROTOCOL%\" response.flags=\"%RESPONSE_FLAGS%\" response.flags-long=\"%RESPONSE_FLAGS_LONG%\" connection.termination-details=\"%CONNECTION_TERMINATION_DETAILS%\" bytes.received=\"%BYTES_RECEIVED%\" bytes.sent=\"%BYTES_SENT%\" duration=\"%DURATION%\" stream.id=\"%STREAM_ID%\" downstream.connection-id=\"%CONNECTION_ID%\" downstream.local-address=\"%DOWNSTREAM_LOCAL_ADDRESS%\" downstream.direct-remote-address=\"%DOWNSTREAM_DIRECT_REMOTE_ADDRESS%\" downstream.remote-address=\"%DOWNSTREAM_REMOTE_ADDRESS%\" downstream.transport-failure-reason=\"%DOWNSTREAM_TRANSPORT_FAILURE_REASON%\" downstream.tls.cipher=\"%DOWNSTREAM_TLS_CIPHER%\" downstream.tls.version=\"%DOWNSTREAM_TLS_VERSION%\" downstream.tls.session-id=\"%DOWNSTREAM_TLS_SESSION_ID%\" upstream.connection-id=\"%UPSTREAM_CONNECTION_ID%\" upstream.host=\"%UPSTREAM_HOST%\" upstream.local-address=\"%UPSTREAM_LOCAL_ADDRESS%\" upstream.remote-address=\"%UPSTREAM_REMOTE_ADDRESS%\" upstream.transport-failure-reason=\"%UPSTREAM_TRANSPORT_FAILURE_REASON%\" upstream.tls.cipher=\"%UPSTREAM_TLS_CIPHER%\" upstream.tls.version=\"%UPSTREAM_TLS_VERSION%\" upstream.tls.session-id=\"%UPSTREAM_TLS_SESSION_ID%\"")
