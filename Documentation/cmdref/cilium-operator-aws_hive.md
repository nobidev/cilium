...
```
  ...
  -h, --help                                                           help for hive
      ...
      --loadbalancer-cp-accesslog-format-hc string                     Envoy Access Log format for T1 -> T2 Health Check HTTP requests that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline)
      --loadbalancer-cp-accesslog-format-http string                   Envoy Access Log format for HTTP requests that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline)
      --loadbalancer-cp-accesslog-format-https string                  Envoy Access Log format for HTTPS requests that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline)
      --loadbalancer-cp-accesslog-format-tcp string                    Envoy Access Log format for the TCP listener that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline)
      --loadbalancer-cp-accesslog-format-tls string                    Envoy Access Log format for TLS requests that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline)
      --loadbalancer-cp-accesslog-format-tls-passthrough string        Envoy Access Log format for TLS passthrough requests that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline)
      --loadbalancer-cp-accesslog-format-udp string                    Envoy Access Log format for the UDP proxy that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline)
      --loadbalancer-cp-accesslog-json-format-hc string                Envoy Access Log JSON format for T1 -> T2 Health Check HTTP requests that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline)
      --loadbalancer-cp-accesslog-json-format-http string              Envoy Access Log JSON format for HTTP requests that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline)
      --loadbalancer-cp-accesslog-json-format-https string             Envoy Access Log JSON format for HTTPS requests that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline)
      --loadbalancer-cp-accesslog-json-format-tcp string               Envoy Access Log JSON format for the TCP listener that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline)
      --loadbalancer-cp-accesslog-json-format-tls string               Envoy Access Log JSON format for TLS requests that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline)
      --loadbalancer-cp-accesslog-json-format-tls-passthrough string   Envoy Access Log JSON format for TLS passthrough requests that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline)
      --loadbalancer-cp-accesslog-json-format-udp string               Envoy Access Log JSON format for the UDP proxy that should be configured on T2 Envoy by the LoadBalancer control plane (without the trailing newline)
      ...
      --loadbalancer-extlb-enabled                                     Enable the External Load Balancer control plane
