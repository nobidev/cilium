...
```
      ...
      --dns-proxy-release-name string                           The Cilium DNS proxy Helm release name for which to get values (default "cilium-dnsproxy")
  ...
  -h, --help                                                    help for sysdump
      ...
      --hubble-integrated-timescape-bugtool-flags stringArray   Optional set of flags to pass to hubble timescape bugtool command.
      --hubble-integrated-timescape-selector string             The labels used to target Hubble Timescape pods (default "k8s-app=hubble-timescape")
      ...
      --hubble-timescape-bugtool-flags stringArray              Optional set of flags to pass to hubble timescape bugtool command.
      --hubble-timescape-helm-release-name string               The Hubble Timescape Helm release name for which to get values (default "hubble-timescape")
      --hubble-timescape-namespace string                       The namespace Hubble Timescape is running in (default "hubble-timescape")
      --hubble-timescape-selector string                        The labels used to target Hubble Timescape pods (default "app.kubernetes.io/part-of=hubble-timescape")
      --hubble-ui-helm-release-name string                      The Hubble UI Helm release name for which to get values (default "hubble-ui")
      --hubble-ui-labels string                                 The labels used to target Hubble UI pods (default "k8s-app=hubble-ui")
      --hubble-ui-namespace string                              The namespace Hubble UI is running in (default "hubble-ui")
...
* [cilium loadbalancer](cilium_loadbalancer.md)	 - Access to Loadbalancer control plane
