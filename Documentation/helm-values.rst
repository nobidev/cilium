...
.. list-table::
   ...
   * - :spelling:ignore:`upgradeCompatibility`
     ...
     - string
     - ``nil``
   * - :spelling:ignore:`vector.commonLabels."app.kubernetes.io/name"`
     - 
     - string
     - ``"cilium-vector"``
   * - :spelling:ignore:`vector.commonLabels."app.kubernetes.io/part-of"`
     - 
     - string
     - ``"cilium"``
   * - :spelling:ignore:`vector.commonLabels.k8s-app`
     - 
     - string
     - ``"cilium-vector"``
   * - :spelling:ignore:`vector.customConfig.api.address`
     - 
     - string
     - ``"127.0.0.1:8686"``
   * - :spelling:ignore:`vector.customConfig.api.enabled`
     - 
     - bool
     - ``true``
   * - :spelling:ignore:`vector.customConfig.api.playground`
     - 
     - bool
     - ``false``
   * - :spelling:ignore:`vector.customConfig.data_dir`
     - 
     - string
     - ``"/vector-data-dir"``
   * - :spelling:ignore:`vector.customConfig.sinks.http_push_timescape.batch.max_size`
     - 
     - string
     - ``"50MB"``
   * - :spelling:ignore:`vector.customConfig.sinks.http_push_timescape.batch.timeout_secs`
     - 
     - int
     - ``5``
   * - :spelling:ignore:`vector.customConfig.sinks.http_push_timescape.encoding.codec`
     - 
     - string
     - ``"raw_message"``
   * - :spelling:ignore:`vector.customConfig.sinks.http_push_timescape.framing.method`
     - 
     - string
     - ``"newline_delimited"``
   * - :spelling:ignore:`vector.customConfig.sinks.http_push_timescape.inputs[0]`
     - 
     - string
     - ``"hubble_logs"``
   * - :spelling:ignore:`vector.customConfig.sinks.http_push_timescape.type`
     - 
     - string
     - ``"http"``
   * - :spelling:ignore:`vector.customConfig.sinks.http_push_timescape.uri`
     - 
     - string
     - ``"http://hubble-timescape.{{ .Release.Namespace }}.svc.cluster.local:4260/push"``
   * - :spelling:ignore:`vector.customConfig.sinks.prom_exporter.address`
     - 
     - string
     - ``"0.0.0.0:9090"``
   * - :spelling:ignore:`vector.customConfig.sinks.prom_exporter.inputs[0]`
     - 
     - string
     - ``"internal_metrics"``
   * - :spelling:ignore:`vector.customConfig.sinks.prom_exporter.type`
     - 
     - string
     - ``"prometheus_exporter"``
   * - :spelling:ignore:`vector.customConfig.sources.hubble_logs.include[0]`
     - 
     - string
     - ``"/var/run/cilium/hubble/hubble.log"``
   * - :spelling:ignore:`vector.customConfig.sources.hubble_logs.include[1]`
     - 
     - string
     - ``"/var/run/cilium/hubble/k8s-events.log"``
   * - :spelling:ignore:`vector.customConfig.sources.hubble_logs.type`
     - 
     - string
     - ``"file"``
   * - :spelling:ignore:`vector.customConfig.sources.internal_metrics.type`
     - 
     - string
     - ``"internal_metrics"``
   * - :spelling:ignore:`vector.extraVolumeMounts[0].mountPath`
     - 
     - string
     - ``"/var/run/cilium/hubble"``
   * - :spelling:ignore:`vector.extraVolumeMounts[0].name`
     - 
     - string
     - ``"hubble-logs"``
   * - :spelling:ignore:`vector.extraVolumeMounts[0].readOnly`
     - 
     - bool
     - ``true``
   * - :spelling:ignore:`vector.extraVolumes[0].hostPath.path`
     - 
     - string
     - ``"/var/run/cilium/hubble"``
   * - :spelling:ignore:`vector.extraVolumes[0].name`
     - 
     - string
     - ``"hubble-logs"``
   * - :spelling:ignore:`vector.fullnameOverride`
     - 
     - string
     - ``"cilium-vector"``
   * - :spelling:ignore:`vector.persistence.hostPath.path`
     - 
     - string
     - ``"/var/lib/vector-cilium"``
   * - :spelling:ignore:`vector.role`
     - 
     - string
     - ``"Agent"``
