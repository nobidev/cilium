...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v2.SchemeGroupVersion.WithResource("ciliumvrfs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Cilium().V2().CiliumVRFs().Informer()}, nil
	...
	case v1alpha1.SchemeGroupVersion.WithResource("fabricsecuritygroups"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Isovalent().V1alpha1().FabricSecurityGroups().Informer()}, nil
	...
	case v1alpha1.SchemeGroupVersion.WithResource("isovalentwafpolicies"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Isovalent().V1alpha1().IsovalentWAFPolicies().Informer()}, nil
