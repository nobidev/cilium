...
type NetworkPolicyConditionApplyConfiguration struct {
	Type               *isovalentcomv1.PolicyConditionType `json:"type,omitempty"`
...
func (b *NetworkPolicyConditionApplyConfiguration) WithType(value isovalentcomv1.PolicyConditionType) *NetworkPolicyConditionApplyConfiguration {
	b.Type = &value
	return b
}
...
func (b *NetworkPolicyConditionApplyConfiguration) WithStatus(value corev1.ConditionStatus) *NetworkPolicyConditionApplyConfiguration {
	b.Status = &value
	return b
}
