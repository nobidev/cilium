...
func (b *BGPServiceOptionsApplyConfiguration) WithAddresses(values ...v2alpha1.BGPServiceAddressType) *BGPServiceOptionsApplyConfiguration {
	for i := range values {
...
func (b *BGPServiceOptionsApplyConfiguration) WithAggregationLengthIPv4(value int32) *BGPServiceOptionsApplyConfiguration {
...
func (b *BGPServiceOptionsApplyConfiguration) WithAggregationLengthIPv6(value int32) *BGPServiceOptionsApplyConfiguration {
