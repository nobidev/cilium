...
type NetworkPolicyConditionApplyConfiguration struct {
	Type               *isovalentcomv1alpha1.PolicyConditionType `json:"type,omitempty"`
...
func (b *NetworkPolicyConditionApplyConfiguration) WithType(value isovalentcomv1alpha1.PolicyConditionType) *NetworkPolicyConditionApplyConfiguration {
	b.Type = &value
	return b
}
