...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LBFrontendRoute) DeepCopyInto(out *LBFrontendRoute) {
	*out = *in
	if in.HTTP != nil {
		in, out := &in.HTTP, &out.HTTP
		*out = new(LBFrontendRouteHTTP)
		(*in).DeepCopyInto(*out)
	}
	if in.HTTPS != nil {
		in, out := &in.HTTPS, &out.HTTPS
		*out = new(LBFrontendRouteHTTPS)
		(*in).DeepCopyInto(*out)
	}
	if in.TLSPassthrough != nil {
		in, out := &in.TLSPassthrough, &out.TLSPassthrough
		*out = new(LBFrontendRouteTLSPassthrough)
		(*in).DeepCopyInto(*out)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LBFrontendRoute.
func (in *LBFrontendRoute) DeepCopy() *LBFrontendRoute {
	if in == nil {
		return nil
	}
	out := new(LBFrontendRoute)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LBFrontendRouteHTTP) DeepCopyInto(out *LBFrontendRouteHTTP) {
	*out = *in
	if in.HostNames != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LBFrontendRouteHTTP.
func (in *LBFrontendRouteHTTP) DeepCopy() *LBFrontendRouteHTTP {
	if in == nil {
		return nil
	}
	out := new(LBFrontendRouteHTTP)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LBFrontendRouteHTTPS) DeepCopyInto(out *LBFrontendRouteHTTPS) {
	*out = *in
	if in.HostNames != nil {
		in, out := &in.HostNames, &out.HostNames
		*out = make([]LBFrontendHostName, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LBFrontendRouteHTTPS.
func (in *LBFrontendRouteHTTPS) DeepCopy() *LBFrontendRouteHTTPS {
	if in == nil {
		return nil
	}
	out := new(LBFrontendRouteHTTPS)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LBFrontendRouteTLSPassthrough) DeepCopyInto(out *LBFrontendRouteTLSPassthrough) {
	*out = *in
	if in.HostNames != nil {
		in, out := &in.HostNames, &out.HostNames
		*out = make([]LBFrontendHostName, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LBFrontendRouteTLSPassthrough.
func (in *LBFrontendRouteTLSPassthrough) DeepCopy() *LBFrontendRouteTLSPassthrough {
	if in == nil {
		return nil
	}
	out := new(LBFrontendRouteTLSPassthrough)
...
func (in *LBFrontendSpec) DeepCopyInto(out *LBFrontendSpec) {
	*out = *in
	...
	if in.TLS != nil {
		...
		*out = new(LBFrontendTLS)
		(*in).DeepCopyInto(*out)
	}
	if in.Routes != nil {
		in, out := &in.Routes, &out.Routes
		*out = make([]LBFrontendRoute, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LBFrontendTLS) DeepCopyInto(out *LBFrontendTLS) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LBFrontendTLS.
func (in *LBFrontendTLS) DeepCopy() *LBFrontendTLS {
	if in == nil {
		return nil
	}
	out := new(LBFrontendTLS)
