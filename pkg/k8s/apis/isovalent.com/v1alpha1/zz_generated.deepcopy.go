...
func (in *LBFrontendApplicationHTTPSProxy) DeepCopyInto(out *LBFrontendApplicationHTTPSProxy) {
	*out = *in
	...
	if in.Routes != nil {
		in, out := &in.Routes, &out.Routes
		*out = make([]LBFrontendHTTPSRoute, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LBFrontendHTTPSRoute) DeepCopyInto(out *LBFrontendHTTPSRoute) {
	*out = *in
	if in.HostNames != nil {
		in, out := &in.HostNames, &out.HostNames
		*out = make([]LBFrontendHostName, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LBFrontendHTTPSRoute.
func (in *LBFrontendHTTPSRoute) DeepCopy() *LBFrontendHTTPSRoute {
	if in == nil {
		return nil
	}
	out := new(LBFrontendHTTPSRoute)
	in.DeepCopyInto(out)
	return out
}
