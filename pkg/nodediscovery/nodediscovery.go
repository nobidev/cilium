...
func (n *NodeDiscovery) mutateNodeResource(ctx context.Context, nodeResource *ciliumv2.CiliumNode, ln *node.LocalNode) error {
	...
	case ipamOption.IPAMENI:
		if err := n.mutateENINodeResource(ctx, nodeResource); err != nil {
			return err
		}

	case ipamOption.IPAMAzure:
		if err := n.mutateAzureNodeResource(ctx, nodeResource, ln); err != nil {
			return err
		}

	case ipamOption.IPAMAlibabaCloud:
		if err := n.mutateAlibabaCloudNodeResource(ctx, nodeResource); err != nil {
			return err
		}
	}
