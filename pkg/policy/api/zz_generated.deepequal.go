...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *PortRulesDNS) DeepEqual(other *PortRulesDNS) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *PortRulesHTTP) DeepEqual(other *PortRulesHTTP) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *PortRulesL7) DeepEqual(other *PortRulesL7) bool {
	if other == nil {
		return false
	}
