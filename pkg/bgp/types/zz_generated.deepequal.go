...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *RoutePolicyActionNextHop) DeepEqual(other *RoutePolicyActionNextHop) bool {
	if other == nil {
		return false
	}
	...
	if in.Unchanged != other.Unchanged {
		return false
	}
...
func (in *RoutePolicyConditions) DeepEqual(other *RoutePolicyConditions) bool {
	...
	if (in.MatchNeighbors == nil) != (other.MatchNeighbors == nil) {
		return false
	} else if in.MatchNeighbors != nil {
		if !in.MatchNeighbors.DeepEqual(other.MatchNeighbors) {
			return false
		}
	}

	if (in.MatchPrefixes == nil) != (other.MatchPrefixes == nil) {
		return false
	} else if in.MatchPrefixes != nil {
		if !in.MatchPrefixes.DeepEqual(other.MatchPrefixes) {
			return false
		}
	}

	if ((in.MatchFamilies != nil) && (other.MatchFamilies != nil)) || ((in.MatchFamilies == nil) != (other.MatchFamilies == nil)) {
		in, other := &in.MatchFamilies, &other.MatchFamilies
		if other == nil {
			return false
		}
...
// deepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *RoutePolicyNeighborMatch) deepEqual(other *RoutePolicyNeighborMatch) bool {
	if other == nil {
		return false
	}
...
// deepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *RoutePolicyPrefix) deepEqual(other *RoutePolicyPrefix) bool {
	if other == nil {
		return false
	}
