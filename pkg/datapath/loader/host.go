...
func reloadHostEndpoint(ctx context.Context, logger *slog.Logger, reg *registry.MapRegistry,
	collLoader *bpfCollectionLoader, ep datapath.Endpoint,
...
func attachNetworkDevices(ctx context.Context, logger *slog.Logger, reg *registry.MapRegistry, collLoader *bpfCollectionLoader, ep datapath.Endpoint, lnc *datapath.LocalNodeConfiguration, spec *ebpf.CollectionSpec) error {
