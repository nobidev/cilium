...
func reinitializeOverlay(ctx context.Context, logger *slog.Logger, reg *registry.MapRegistry,
	collLoader *bpfCollectionLoader, lnc *datapath.LocalNodeConfiguration, tunnelConfig tunnel.Config) error {
...
func reinitializeWireguard(ctx context.Context, logger *slog.Logger, reg *registry.MapRegistry, collLoader *bpfCollectionLoader, lnc *datapath.LocalNodeConfiguration) (err error) {
...
func reinitializeXDPLocked(ctx context.Context, logger *slog.Logger, reg *registry.MapRegistry,
	collLoader *bpfCollectionLoader, lnc *datapath.LocalNodeConfiguration, devices []string) error {
