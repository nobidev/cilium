...
// BPFEvpnBase is a configuration struct for a Cilium datapath object.
//
// Warning: do not instantiate directly! Always use [NewBPFEvpnBase] to ensure
...
func NewBPFEvpnBase(node Node) *BPFEvpnBase {
	return &BPFEvpnBase{0x5dc, false, false, false, false, false, false, 0x0, 0x0,
