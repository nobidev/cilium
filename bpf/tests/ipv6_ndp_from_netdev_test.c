...
const unsigned char v6_ndp_pod_ns_llopt[] = {
	SCAPY_BUF_BYTES(v6_ndp_pod_ns_llopt)
};

/* packet defined in ./scapy/ipv6_ndp_pkt_defs.py */
const unsigned char v6_ndp_pod_ns[] = {
	SCAPY_BUF_BYTES(v6_ndp_pod_ns)
};

/* packet defined in ./scapy/ipv6_ndp_pkt_defs.py */
const unsigned char v6_ndp_pod_na_llopt[] = {
	SCAPY_BUF_BYTES(v6_ndp_pod_na_llopt)
};

/* packet defined in ./scapy/ipv6_ndp_pkt_defs.py */
const unsigned char v6_ndp_pod_ns_mcast_llopt[] = {
	SCAPY_BUF_BYTES(v6_ndp_pod_ns_mcast_llopt)
};

/* packet defined in ./scapy/ipv6_ndp_pkt_defs.py */
const unsigned char v6_ndp_pod_ns_mcast[] = {
	SCAPY_BUF_BYTES(v6_ndp_pod_ns_mcast)
};

/* packet defined in ./scapy/ipv6_ndp_pkt_defs.py */
const unsigned char v6_ndp_node_ns_llopt[] = {
	SCAPY_BUF_BYTES(v6_ndp_node_ns_llopt)
};

/* packet defined in ./scapy/ipv6_ndp_pkt_defs.py */
const unsigned char v6_ndp_node_ns[] = {
	SCAPY_BUF_BYTES(v6_ndp_node_ns)
};

/* packet defined in ./scapy/ipv6_ndp_pkt_defs.py */
const unsigned char v6_ndp_node_ns_mcast_llopt[] = {
	SCAPY_BUF_BYTES(v6_ndp_node_ns_mcast_llopt)
};

/* packet defined in ./scapy/ipv6_ndp_pkt_defs.py */
const unsigned char v6_ndp_node_ns_mcast[] = {
