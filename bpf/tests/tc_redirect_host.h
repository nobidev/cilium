...
const unsigned char tc_redirect_host_ipv4_pre[] = {
	SCAPY_BUF_BYTES(tc_redirect_host_ipv4_pre)
};

/* packet defined in ./scapy/tc_redirect_pkt_defs.py */
const unsigned char tc_redirect_host_ipv4_post[] = {
...
int tc_redirect_host_ipv4_pktgen(struct __ctx_buff *ctx)
{
	...
	scapy__push_data(&builder, (void *)tc_redirect_host_ipv4_pre,
...
/* packet defined in ./scapy/tc_redirect_pkt_defs.py */
const unsigned char tc_redirect_host_ipv6_pre[] = {
	SCAPY_BUF_BYTES(tc_redirect_host_ipv6_pre)
};

/* packet defined in ./scapy/tc_redirect_pkt_defs.py */
const unsigned char tc_redirect_host_ipv6_post[] = {
...
int tc_redirect_host_ipv6_pktgen(struct __ctx_buff *ctx)
{
	...
	scapy__push_data(&builder, (void *)tc_redirect_host_ipv6_pre,
