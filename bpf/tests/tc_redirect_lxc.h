...
const unsigned char tc_redirect_lxc_ipv4_pre[] = {
	SCAPY_BUF_BYTES(tc_redirect_lxc_ipv4_pre)
};

/* packet defined in ./scapy/tc_redirect_pkt_defs.py */
const unsigned char tc_redirect_lxc_ipv4_post[] = {
...
/* packet defined in ./scapy/tc_redirect_pkt_defs.py */
const unsigned char tc_redirect_lxc_ipv6_pre[] = {
	SCAPY_BUF_BYTES(tc_redirect_lxc_ipv6_pre)
};

/* packet defined in ./scapy/tc_redirect_pkt_defs.py */
const unsigned char tc_redirect_lxc_ipv6_post[] = {
