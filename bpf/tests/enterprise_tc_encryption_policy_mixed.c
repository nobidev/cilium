...
int encryption_policy_native_v4_tcp_match_setup(struct __ctx_buff *ctx)
{
	...
	ipcache_v4_add_entry(POD1_IPV4, 0, 1000, POD1_TUNNEL_IPV4, 255);
	ipcache_v4_add_entry(POD2_IPV4, 0, 2000, POD2_TUNNEL_IPV4, 255);
...
{
	/* install ipcache entries for both endpoints */
	ipcache_v4_add_entry(POD1_IPV4, 0, 1001, POD1_TUNNEL_IPV4, 255);
...
{
	/* install ipcache entries for both endpoints */
	ipcache_v6_add_entry((union v6addr *)POD1_IPV6, 0, 1000, POD1_TUNNEL_IPV4, 255);
	ipcache_v6_add_entry((union v6addr *)POD2_IPV6, 0, 2000, POD2_TUNNEL_IPV4, 255);
...
{
	/* install ipcache entries for both endpoints */
	ipcache_v6_add_entry((union v6addr *)POD1_IPV6, 0, 1001, POD1_TUNNEL_IPV4, 255);
	ipcache_v6_add_entry((union v6addr *)POD2_IPV6, 0, 2001, POD2_TUNNEL_IPV4, 255);
...
int encryption_policy_vxlan_v6_tcp_no_match_setup(struct __ctx_buff *ctx)
{
	/* install ipcache entries for both endpoints */
	ipcache_v6_add_entry((union v6addr *)POD1_IPV6, 0, 1001, POD1_TUNNEL_IPV4, 255);
	ipcache_v6_add_entry((union v6addr *)POD2_IPV6, 0, 2002, POD2_TUNNEL_IPV4, 255);
