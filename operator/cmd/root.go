...
var (
	...
	ControlPlaneLeaderCells = []cell.Cell{
		...
		cell.Provide(func(cfg *operatorOption.OperatorConfig, dcfg *option.DaemonConfig, svcV2Cfg cmtypes.ServiceModeV2Config) operatorWatchers.ServiceSyncConfig {
			return operatorWatchers.ServiceSyncConfig{
				Enabled: cfg.SyncK8sServices && svcV2Cfg.ServiceModeV2.ShouldExportLegacyServices(),
			}
		}),
		cell.Provide(func(cfg *operatorOption.OperatorConfig, dcfg *option.DaemonConfig) operatorWatchers.EndpointSliceExportSyncConfig {
