            ...
            steps {
                ...
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:af7737e88d61fbaf90804ca86ae3e1e481d2e4e9@sha256:d5825a63235b3eb3ce8d6d7747b2a4d62e93b7c0d3d2a5d2c580dd406c2b1f57"
                    }
                }
            }
        }
