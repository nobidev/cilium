...
const file_observer_observer_proto_rawDesc = "" +
	...
	"\n" +
	"flows_rate\x18\t \x01(\x01R\tflowsRate\"\xb5\x04\n" +
	...
	"extensions\x12<\n" +
	"\vaggregation\x18\x91N \x01(\v2\x15.observer.AggregationB\x02\x18\x01R\vaggregation\x1a\x14\n" +
...
var file_observer_observer_proto_depIdxs = []int32{
	...
	4,  // 41: observer.Observer.GetFlows:input_type -> observer.GetFlowsRequest
	6,  // 42: observer.Observer.GetAgentEvents:input_type -> observer.GetAgentEventsRequest
	8,  // 43: observer.Observer.GetDebugEvents:input_type -> observer.GetDebugEventsRequest
	10, // 44: observer.Observer.GetNodes:input_type -> observer.GetNodesRequest
	14, // 45: observer.Observer.GetNamespaces:input_type -> observer.GetNamespacesRequest
	2,  // 46: observer.Observer.ServerStatus:input_type -> observer.ServerStatusRequest
	5,  // 47: observer.Observer.GetFlows:output_type -> observer.GetFlowsResponse
	7,  // 48: observer.Observer.GetAgentEvents:output_type -> observer.GetAgentEventsResponse
	9,  // 49: observer.Observer.GetDebugEvents:output_type -> observer.GetDebugEventsResponse
	11, // 50: observer.Observer.GetNodes:output_type -> observer.GetNodesResponse
	15, // 51: observer.Observer.GetNamespaces:output_type -> observer.GetNamespacesResponse
	3,  // 52: observer.Observer.ServerStatus:output_type -> observer.ServerStatusResponse
