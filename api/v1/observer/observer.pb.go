...
const file_observer_observer_proto_rawDesc = "" +
	"\n" +
	"\x17observer/observer.proto\x12\bobserver\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x0fflow/flow.proto\x1a\x11relay/relay.proto\"\x15\n" +
	...
	"\n" +
	"flows_rate\x18\t \x01(\x01R\tflowsRate\"\xee\x04\n" +
	...
	"extensions\x12<\n" +
	"\vaggregation\x18\x91N \x01(\v2\x15.observer.AggregationB\x02\x18\x01R\vaggregation\x1aM\n" +
	"\fExperimental\x12=\n" +
	"\n" +
	...
	"\x0eclose_requests\x18\b \x01(\x04R\rcloseRequests:\x02\x18\x01\"\xa4\x01\n" +
	"\x0eFlowStatistics\x127\n" +
	"\aforward\x18\x01 \x01(\v2\x1d.observer.DirectionStatisticsR\aforward\x123\n" +
	"\x05reply\x18\x02 \x01(\v2\x1d.observer.DirectionStatisticsR\x05reply\x12 \n" +
	"\vestablished\x18\x03 \x01(\bR\vestablished:\x02\x18\x01\"\xd2\x01\n" +
	"\n" +
	"Aggregator\x12,\n" +
	"\x04type\x18\x01 \x01(\x0e2\x18.observer.AggregatorTypeR\x04type\x12,\n" +
	...
	"\trenew_ttl\x18\x04 \x01(\v2\x1a.google.protobuf.BoolValueR\brenewTtl:\x02\x18\x01\"\x90\x01\n" +
	"\vAggregation\x126\n" +
	"\vaggregators\x18\x01 \x03(\v2\x14.observer.AggregatorR\vaggregators\x12E\n" +
	"\x13state_change_filter\x18\x02 \x01(\x0e2\x15.observer.StateChangeR\x11stateChangeFilter:\x02\x18\x01*p\n" +
	"\vStateChange\x12\n" +
	"\n" +
	...
	"\vfirst_reply\x10 \x1a\x02\x18\x01*?\n" +
	"\x0eAggregatorType\x12\v\n" +
	"\aunknown\x10\x00\x12\x0e\n" +
	"\n" +
	"connection\x10\x01\x12\f\n" +
	"\bidentity\x10\x02\x1a\x02\x18\x012\xed\x03\n" +
	"\bObserver\x12E\n" +
	...
	"\fServerStatus\x12\x1d.observer.ServerStatusRequest\x1a\x1e.observer.ServerStatusResponse\"\x00B*Z(github.com/cilium/cilium/api/v1/observerP\x05b\x06proto3"
